...
import { i as WatchBox, n as ShortcutBox } from "./Callouts-jDkcxPuu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/tricks-Co-pcnMW.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Keep these on a mental sticky note. Most missed C955 items are wording, not arithmetic."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-8 space-y-4",
				children: TRICKS.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShortcutBox, {
						title: t.title,
						children: t.body
					}), t.watch ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WatchBox, {
						words: t.watch.split("·").map((s) => s.trim()).filter(Boolean),
						children: "If you see these words, reach for this trick first."
					}) : null]
				}, t.id))
			})
		]
...
//#endregion
export { TricksPage as component };
